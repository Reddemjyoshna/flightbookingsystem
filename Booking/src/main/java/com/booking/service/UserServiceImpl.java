...
//to get autogenerated id
	...
	public void sendEmail(long pnrNo) throws AddressException {
		...
		final Email email = DefaultEmail.builder().from(new InternetAddress("jyoshnareddy63040@gmail.com"))
				.replyTo(new InternetAddress("jyoshnareddy@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("jyoshnareddy63040@gmail.com"))).subject("Your Flight is booked")
